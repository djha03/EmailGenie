...
export default function EditListing() {
  ...
  useEffect(()=>{
    if(listing && listing.userRef !== auth.currentUser.uid){
        toast.error("You can not edit this Email!!")
        navigate("/");
    }
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      <h1 className="text-3xl text-center mt-6 font-bold">Edit Email</h1>
      <form onSubmit={onSubmit}>
        <p className="text-lg mt-6 font-semibold">Send / Reply</p>
        <div className="flex">
          <button
            type="button"
            id="type"
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            <p className="text-lg mt-6 font-semibold">To</p>
            <input
              type="number"
              id="to"
              value={to}
          ...
          <div>
            <p className="text-lg mt-6 font-semibold">CC</p>
            <input
              type="number"
              id="cc"
              value={cc}
